...
const OurFeatured = () => {
  return (
    <div className="my-16 md:mx-6 mx-4">
      <div className="mb-6">
        <Heading
          heading="Introducing Our Features"
          subHeading="We understand the importance of innovation and professionalism and work with the best people to achieve this."
        />
      </div>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-7 mr-[7px]">
        <div className="card-box">
          <div className=" md:w-[330px] w-80 mx-auto flex items-center justify-center flex-col space-y-1 card">
            <img src={team} alt="" className="w-16" />
            <h4 className="text-xl font-bold text-white">Professional Team</h4>
            <p className="w-9/12 text-center text-sm font-light">
              It is a long established fact that reader by the readable content
